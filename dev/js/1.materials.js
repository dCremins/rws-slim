...
// Geometry
const coneGeometry = new THREE.CylinderGeometry(0.15, 0.5, 1.2, 4, 0.8, false, 0.8)
const coneBottomG = new THREE.BoxGeometry(1, 0.2, 1)
coneBottomG.translate(0, -0.5, 0)
coneGeometry.merge(coneBottomG)
coneGeometry.translate(0, 0.3, 0)
